...
function mergeChannelContent(payload) {
  ...
  result.about = {
    // Simplified fields for the new about page
    aboutTitle: sanitizeString(aboutPayload.aboutTitle, 'About'),
    aboutContent: sanitizeString(aboutPayload.aboutContent, aboutDefaults.lead),
