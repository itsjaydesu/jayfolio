...
function mergeChannelContent(payload) {
  ...
  result.about = {
    ...
    aboutBackgroundImage: sanitizeString(aboutPayload.aboutBackgroundImage, aboutDefaults.aboutBackgroundImage),
    
    // Footer fade settings
    aboutFooterFadeSettings: aboutPayload.aboutFooterFadeSettings || aboutDefaults.aboutFooterFadeSettings,
    ...
    aboutLead: sanitizeLocalizedField(aboutPayload.aboutLead, aboutDefaults.aboutLead),
  ...
  for (const key of ['projects', 'content', 'sounds', 'art']) {
    ...
    result[key] = {
      backgroundImage: sanitizeString(payloadChannel.backgroundImage, defaultsChannel.backgroundImage),
      footerFadeSettings: payloadChannel.footerFadeSettings || defaultsChannel.footerFadeSettings,
