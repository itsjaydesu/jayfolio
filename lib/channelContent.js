...
function mergeChannelContent(payload) {
  ...
  result.about = {
    ...
    aboutTitle: sanitizeString(aboutPayload.aboutTitle, aboutDefaults.aboutTitle),
    aboutSubtitle: sanitizeString(aboutPayload.aboutSubtitle, aboutDefaults.aboutSubtitle),
    aboutContent: sanitizeString(aboutPayload.aboutContent, aboutDefaults.aboutContent),
    aboutDetailCards: sanitizeDetailCards(aboutPayload.aboutDetailCards, aboutDefaults.aboutDetailCards),
    aboutTags: sanitizeStringList(aboutPayload.aboutTags, aboutDefaults.aboutTags),
  ...
  for (const key of ['projects', 'words', 'sounds', 'art']) {
    const defaultsChannel = defaults[key];
    const payloadChannel = payload[key] ?? {};
    result[key] = {
      title: sanitizeString(payloadChannel.title, defaultsChannel.title),
      lead: sanitizeString(payloadChannel.lead, defaultsChannel.lead)
    };
  }
