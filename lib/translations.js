...
export const TRANSLATIONS = {
  en: {
    ...
    'channel.settings.description': 'Select a channel to edit its contextual hero content.',
    'channel.about.title': 'About Channel Copy',
    'channel.about.description': 'Edit the about capsule hero, history, and studio signals.',
    'channel.projects.title': 'Projects Hero Copy',
    'channel.projects.description': 'Update the projects hero title and lead text.',
    'channel.content.title': 'Content Hero Copy',
    'channel.content.description': 'Tune the content hero headline and descriptive lead.',
    'channel.sounds.title': 'Sounds Hero Copy',
    'channel.sounds.description': 'Adjust the sounds hero headline and supporting copy.',
    'channel.art.title': 'Art Hero Copy',
    'channel.art.description': 'Curate the art hero headline with language tuned for generative studies.',
    
    // Field Settings (Admin)
    'field.settings.title': 'Field Settings',
    'field.settings.description': 'Adjust the dotfield baseline and per-channel overrides.',
    ...
    'field.overrides.description': 'Overrides applied when visitors open this channel.',
    ...
    'language.toggle.aria.en': 'Current language: English. Click to switch to Japanese',
    'language.toggle.aria.ja': 'Current language: Japanese. Click to switch to English',
  ...
  ja: {
    ...
    'nav.about': 'ジェイについて',
    'nav.projects': 'プロジェクト',
    'nav.content': 'コンテンツ＆記事',
    'nav.sounds': 'サウンド',
    'nav.art': 'アートワーク',
    'nav.mobile-menu-label': 'ページを選択してください',
    'nav.mobile-menu-placeholder': '移動先を選んでください',
    
    // Content Page
    'content.title': 'コンテンツ＆ライティング',
    'content.lead': 'テクノロジー、文化、そして現代社会の滑稽さを探るエッセイ、ブログ、コメディ作品。開いたエントリーでは埋め込みメディアと参考文献付きで全文を読めます。',
    'content.all': 'すべて',
    'content.essays': 'エッセイ',
    'content.blog': 'ブログ',
    'content.comedy': 'コメディ',
    ...
    // Sounds Page
    'sounds.empty': 'サウンドエントリーはまだありません。管理コンソールから追加してください。',

    // Art Page
    'art.empty': 'アートエントリーはまだありません。管理コンソールから追加してください。',
    
    // Admin Channel Settings
    'channel.settings.title': 'チャンネルコピー',
    'channel.settings.description': '編集したいチャンネルを選び、ヒーローコピーを調整します。',
    'channel.about.title': 'Aboutチャンネルコピー',
    'channel.about.description': 'Aboutのヒーロー文章、沿革、スタジオシグナルを編集します。',
    'channel.projects.title': 'プロジェクトヒーローコピー',
    'channel.projects.description': 'プロジェクトの見出しとリード文を更新します。',
    ...
    'channel.art.description': 'ジェネラティブスタディ向けにアートの見出しを整えます。',
    
    // Field Settings (Admin)
    'field.settings.title': 'フィールド設定',
    'field.settings.description': 'ドットフィールドのベースラインとチャンネルごとのオーバーライドを調整します。',
    ...
    'field.overrides.description': '訪問者がこのチャンネルを開いたときに適用されるオーバーライド。',
    ...
    'language.toggle.aria.en': '現在の言語: 英語。クリックすると日本語に切り替わります',
    'language.toggle.aria.ja': '現在の言語: 日本語。クリックすると英語に切り替わります',
    'return.home': 'ホームに戻る',
    ...
    'menu.close': '閉じる',
    'menu.field-effects': 'フィールドエフェクト',
    'menu.tooltip.effect-active': '「{effect}」が作動中',
    'menu.tooltip.reset-timer': 'リセットまで{seconds}秒',
    'menu.tooltip.no-auto-reset': '自動リセットはありません',
    'effects.calmReset': '禅モード',
    'effects.calmReset.tooltip': '初期状態へ静かに戻す',
    'effects.jitter': 'ジッター',
    'effects.jitter.tooltip': '瞬間的なリップルを連続発生させる',
    'effects.swirlPulse': 'スワール',
    'effects.swirlPulse.tooltip': '渦のうねりを強く浮かび上がらせる',
    'effects.spiralFlow': 'スパイラル',
    'effects.spiralFlow.tooltip': '対数螺旋の流れを描き出す',
    'effects.riverFlow': 'クエイク',
    'effects.riverFlow.tooltip': 'フィールド全体へ地震波のような揺らぎを走らせる',
    'effects.mandelbrotZoom': 'ホップ',
    'effects.mandelbrotZoom.tooltip': 'ジュリア集合の渦へ飛び込みズームする',
    'effects.reactionDiffusionBloom': 'ブルーム',
    'effects.reactionDiffusionBloom.tooltip': 'グレイ・スコット模様を芽吹かせる',
    'effects.harmonicPendulum': 'ブリンク',
    'effects.harmonicPendulum.tooltip': 'カオスな振り子の軌跡を描き出す',
    'effects.starfield': 'スターズ',
    'effects.starfield.tooltip': '漂う星雲へ変調させる'
  }
};
