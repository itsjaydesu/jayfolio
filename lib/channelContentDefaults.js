export const CHANNEL_CONTENT_DEFAULTS = {
  about: {
    ...
    // Footer fade settings for fine-tuning
    aboutFooterFadeSettings: {
      bgPosition: "70", // Background position percentage
      bgScale: "cover", // Background size (cover, contain, or percentage like 120%)
      topFadeHeight: "60", // Top gradient height %
      topFadeOpacity: "1", // Start opacity (0-1)
      bottomFadeHeight: "40", // Bottom gradient height %
      bottomFadeOpacity: "0.95", // Start opacity (0-1)
      sideFadeWidth: "30", // Side gradient width %
      sideFadeOpacity: "0.8", // Side gradient opacity (0-1)
    },
    ...
    aboutDetailCards: [
      {
        ...
        text: {
          ...
          ja: "シネマティックなUIシステム、没入型の空間オーディオ、センサー駆動の振付、共同デザインリサーチを探ります。",
        },
      },
      {
        title: {
        ...
        text: {
          ...
          ja: "まず耳を傾け、オープンに試作し、あらゆるサーフェスに温度を灯す。プロジェクトではコードと同じ精度で空気感を整えます。",
        },
      },
      {
        title: {
        ...
        text: {
          ...
          ja: "WebGLとリアルタイムシステムで、光・音・インターフェースのジェスチャーが同じ鼓動を共有する世界を構築しています。",
        },
      },
    ],
    aboutTags: {
    ...
    // Legacy fields
    title: "",
    lead: "Creative technologist guiding teams through ambient operating systems, tactile exhibition tooling, and cinematic web soundscapes. This dossier carries the studio ethos, collaborators, and signals shaping each commission. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.",
    ...
    signals: [
      {
        ...
        description:
          "Lorem ipsum interfaces, ambient OS prototypes, spatial sound choreography.",
      },
      {
