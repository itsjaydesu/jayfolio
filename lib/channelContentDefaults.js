export const CHANNEL_CONTENT_DEFAULTS = {
  ...
  projects: {
    ...
    title: "Projects",
    lead: "Explore interactive commissions, touring installations, and responsive tooling. Choose any dossier to open a full breakdown with media, credits, and embedded documentation.",
  },
  content: {
    backgroundImage: "",
    footerFadeSettings: {
    ...
    title: "Content",
    lead: "Essays, dispatches, and glossaries documenting the studio process. Open any log to read the full rich-text entry with embedded media and references.",
  },
  sounds: {
    backgroundImage: "",
    footerFadeSettings: {
  ...
  art: {
    ...
    lead: "Generative canvases, shader sketches, and motion field studies charting how the dot array mutates across performances.",
  },
};
