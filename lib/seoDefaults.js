export const SEO_DEFAULTS = {
  ...
  pages: {
    ...
    art: {
      title: 'Art',
      description: 'Generative dot field studies, shader sketches, and motion-driven installations.',
      keywords: ['generative art', 'shader', 'dot field'],
  ...
  contentTemplates: {
    ...
    content: {
      titleTemplate: '%s - Content | Jay Winder',
    ...
    art: {
      titleTemplate: '%s - Art | Jay Winder',
      descriptionTemplate: 'Art study: %s',
      type: 'article'
    }
  }
};
