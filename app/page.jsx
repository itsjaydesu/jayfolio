  ...
  return (
    <>
      ...
      <section>
        ...
        <p>
          The floating GUI exposes amplitude, glow, rotation, and ripple behaviour. Randomize to explore alternate moods
          or export the current configuration to revisit later. Everything you see is placeholder copy for now—swap it
          with true content once the structure feels right.
        </p>
      </section>
    </>
  );
